...
def grill_sac_onpolicy_online_vae_full_experiment(variant):
    variant['grill_variant']['save_vae_data'] = True
    full_experiment_variant_preprocess(variant)
    train_vae_and_update_variant(variant)
    grill_her_sac_experiment_onpolicy_online_vae(variant['grill_variant'])
...
def grill_her_sac_experiment_onpolicy_online_vae(variant):
    import rlkit.samplers.rollout_functions as rf
    import rlkit.torch.pytorch_util as ptu
    import rlkit.samplers.rollout_functions as rf
    from rlkit.data_management.online_vae_replay_buffer import \
