...
DOODAD_DOCKER_IMAGE = 'anair17/railrl-gpu-v6-cuda9' # 'anair17/railrl-gpu-v6' # 'vitchyr/railrl-vitchyr-gpu-v2-2'
...
GPU_DOODAD_DOCKER_IMAGE = 'anair17/railrl-gpu-v6-cuda9' #  # 'vitchyr/railrl-vitchyr-gpu-v3'
